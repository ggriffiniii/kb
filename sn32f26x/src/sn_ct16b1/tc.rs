...
#[doc = "Field `TC` reader - Timer Counter"]
pub type TC_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TC` writer - Timer Counter"]
pub type TC_W<'a> = crate::FieldWriter<'a, u32, TC_SPEC, u16, u16, 16, 0>;
impl R {
    #[doc = "Bits 0:15 - Timer Counter"]
    #[inline(always)]
    pub fn tc(&self) -> TC_R {
