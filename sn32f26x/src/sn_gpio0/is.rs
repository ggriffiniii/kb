...
#[doc = "Interrupt on Pn.11 is event or edge sensitive\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IS11_A {
    #[doc = "0: Interrupt on Pn.11 is edge sensitive"]
    EDGE = 0,
    #[doc = "1: Interrupt on Pn.11 is event sensitive"]
    EVENT = 1,
}
impl From<IS11_A> for bool {
    #[inline(always)]
    fn from(variant: IS11_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IS11` reader - Interrupt on Pn.11 is event or edge sensitive"]
pub type IS11_R = crate::BitReader<IS11_A>;
impl IS11_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IS11_A {
        match self.bits {
            false => IS11_A::EDGE,
            true => IS11_A::EVENT,
        }
...
#[doc = "Field `IS11` writer - Interrupt on Pn.11 is event or edge sensitive"]
pub type IS11_W<'a> = crate::BitWriter<'a, u32, IS_SPEC, IS11_A, 11>;
impl<'a> IS11_W<'a> {
    #[doc = "Interrupt on Pn.11 is edge sensitive"]
    #[inline(always)]
    pub fn edge(self) -> &'a mut W {
        self.variant(IS11_A::EDGE)
    }
    #[doc = "Interrupt on Pn.11 is event sensitive"]
    #[inline(always)]
    pub fn event(self) -> &'a mut W {
        self.variant(IS11_A::EVENT)
    }
}
#[doc = "Interrupt on Pn.12 is event or edge sensitive\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IS12_A {
    #[doc = "0: Interrupt on Pn.12 is edge sensitive"]
    EDGE = 0,
    #[doc = "1: Interrupt on Pn.12 is event sensitive"]
    EVENT = 1,
}
impl From<IS12_A> for bool {
    #[inline(always)]
    fn from(variant: IS12_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IS12` reader - Interrupt on Pn.12 is event or edge sensitive"]
pub type IS12_R = crate::BitReader<IS12_A>;
impl IS12_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IS12_A {
        match self.bits {
            false => IS12_A::EDGE,
            true => IS12_A::EVENT,
        }
...
#[doc = "Field `IS12` writer - Interrupt on Pn.12 is event or edge sensitive"]
pub type IS12_W<'a> = crate::BitWriter<'a, u32, IS_SPEC, IS12_A, 12>;
impl<'a> IS12_W<'a> {
    #[doc = "Interrupt on Pn.12 is edge sensitive"]
    #[inline(always)]
    pub fn edge(self) -> &'a mut W {
        self.variant(IS12_A::EDGE)
    }
    #[doc = "Interrupt on Pn.12 is event sensitive"]
    #[inline(always)]
    pub fn event(self) -> &'a mut W {
        self.variant(IS12_A::EVENT)
    }
}
#[doc = "Interrupt on Pn.13 is event or edge sensitive\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IS13_A {
    #[doc = "0: Interrupt on Pn.13 is edge sensitive"]
    EDGE = 0,
    #[doc = "1: Interrupt on Pn.13 is event sensitive"]
    EVENT = 1,
}
impl From<IS13_A> for bool {
    #[inline(always)]
    fn from(variant: IS13_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IS13` reader - Interrupt on Pn.13 is event or edge sensitive"]
pub type IS13_R = crate::BitReader<IS13_A>;
impl IS13_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IS13_A {
        match self.bits {
            false => IS13_A::EDGE,
            true => IS13_A::EVENT,
        }
...
#[doc = "Field `IS13` writer - Interrupt on Pn.13 is event or edge sensitive"]
pub type IS13_W<'a> = crate::BitWriter<'a, u32, IS_SPEC, IS13_A, 13>;
impl<'a> IS13_W<'a> {
    #[doc = "Interrupt on Pn.13 is edge sensitive"]
    #[inline(always)]
    pub fn edge(self) -> &'a mut W {
        self.variant(IS13_A::EDGE)
    }
    #[doc = "Interrupt on Pn.13 is event sensitive"]
    #[inline(always)]
    pub fn event(self) -> &'a mut W {
        self.variant(IS13_A::EVENT)
    }
}
#[doc = "Interrupt on Pn.14 is event or edge sensitive\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IS14_A {
    #[doc = "0: Interrupt on Pn.14 is edge sensitive"]
    EDGE = 0,
    #[doc = "1: Interrupt on Pn.14 is event sensitive"]
    EVENT = 1,
}
impl From<IS14_A> for bool {
    #[inline(always)]
    fn from(variant: IS14_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IS14` reader - Interrupt on Pn.14 is event or edge sensitive"]
pub type IS14_R = crate::BitReader<IS14_A>;
impl IS14_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IS14_A {
        match self.bits {
            false => IS14_A::EDGE,
            true => IS14_A::EVENT,
        }
...
#[doc = "Field `IS14` writer - Interrupt on Pn.14 is event or edge sensitive"]
pub type IS14_W<'a> = crate::BitWriter<'a, u32, IS_SPEC, IS14_A, 14>;
impl<'a> IS14_W<'a> {
    #[doc = "Interrupt on Pn.14 is edge sensitive"]
    #[inline(always)]
    pub fn edge(self) -> &'a mut W {
        self.variant(IS14_A::EDGE)
    }
    #[doc = "Interrupt on Pn.14 is event sensitive"]
    #[inline(always)]
    pub fn event(self) -> &'a mut W {
        self.variant(IS14_A::EVENT)
    }
}
#[doc = "Interrupt on Pn.15 is event or edge sensitive\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IS15_A {
    #[doc = "0: Interrupt on Pn.15 is edge sensitive"]
    EDGE = 0,
    #[doc = "1: Interrupt on Pn.15 is event sensitive"]
    EVENT = 1,
}
impl From<IS15_A> for bool {
    #[inline(always)]
    fn from(variant: IS15_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IS15` reader - Interrupt on Pn.15 is event or edge sensitive"]
pub type IS15_R = crate::BitReader<IS15_A>;
impl IS15_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IS15_A {
        match self.bits {
            false => IS15_A::EDGE,
            true => IS15_A::EVENT,
        }
...
#[doc = "Field `IS15` writer - Interrupt on Pn.15 is event or edge sensitive"]
pub type IS15_W<'a> = crate::BitWriter<'a, u32, IS_SPEC, IS15_A, 15>;
impl<'a> IS15_W<'a> {
    #[doc = "Interrupt on Pn.15 is edge sensitive"]
    #[inline(always)]
    pub fn edge(self) -> &'a mut W {
        self.variant(IS15_A::EDGE)
    }
    #[doc = "Interrupt on Pn.15 is event sensitive"]
    #[inline(always)]
    pub fn event(self) -> &'a mut W {
        self.variant(IS15_A::EVENT)
    }
}
impl R {
    ...
    #[doc = "Bit 11 - Interrupt on Pn.11 is event or edge sensitive"]
    #[inline(always)]
    pub fn is11(&self) -> IS11_R {
        IS11_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Interrupt on Pn.12 is event or edge sensitive"]
    #[inline(always)]
    pub fn is12(&self) -> IS12_R {
        IS12_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Interrupt on Pn.13 is event or edge sensitive"]
    #[inline(always)]
    pub fn is13(&self) -> IS13_R {
        IS13_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Interrupt on Pn.14 is event or edge sensitive"]
    #[inline(always)]
    pub fn is14(&self) -> IS14_R {
        IS14_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Interrupt on Pn.15 is event or edge sensitive"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 11 - Interrupt on Pn.11 is event or edge sensitive"]
    #[inline(always)]
    pub fn is11(&mut self) -> IS11_W {
        IS11_W::new(self)
    }
    #[doc = "Bit 12 - Interrupt on Pn.12 is event or edge sensitive"]
    #[inline(always)]
    pub fn is12(&mut self) -> IS12_W {
        IS12_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt on Pn.13 is event or edge sensitive"]
    #[inline(always)]
    pub fn is13(&mut self) -> IS13_W {
        IS13_W::new(self)
    }
    #[doc = "Bit 14 - Interrupt on Pn.14 is event or edge sensitive"]
    #[inline(always)]
    pub fn is14(&mut self) -> IS14_W {
        IS14_W::new(self)
    }
    #[doc = "Bit 15 - Interrupt on Pn.15 is event or edge sensitive"]
    #[inline(always)]
    pub fn is15(&mut self) -> IS15_W {
        IS15_W::new(self)
    }
