...
#[doc = "Field `DIV` reader - SPIn SCK=SPIn_PCLK/(2*DIV+2)"]
pub type DIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIV` writer - SPIn SCK=SPIn_PCLK/(2*DIV+2)"]
pub type DIV_W<'a> = crate::FieldWriter<'a, u32, CLKDIV_SPEC, u8, u8, 8, 0>;
impl R {
    #[doc = "Bits 0:7 - SPIn SCK=SPIn_PCLK/(2*DIV+2)"]
    #[inline(always)]
