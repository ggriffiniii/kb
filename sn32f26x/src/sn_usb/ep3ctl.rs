#[doc = "Register `EP3CTL` reader"]
pub struct R(crate::R<EP3CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP3CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP3CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP3CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EP3CTL` writer"]
pub struct W(crate::W<EP3CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP3CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP3CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP3CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENDP_CNT_W<'a> = crate::FieldWriter<'a, u32, EP3CTL_SPEC, u8, u8, 7, 0>;
...
pub type ENDP_STATE_W<'a> = crate::FieldWriterSafe<'a, u32, EP3CTL_SPEC, u8, ENDP_STATE_A, 2, 29>;
...
#[doc = "Endpoint 3 Function enable bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ENDP_EN_A {
    #[doc = "0: Disable"]
    _0 = 0,
...
#[doc = "Field `ENDP_EN` reader - Endpoint 3 Function enable bit"]
...
#[doc = "Field `ENDP_EN` writer - Endpoint 3 Function enable bit"]
pub type ENDP_EN_W<'a> = crate::BitWriter<'a, u32, EP3CTL_SPEC, ENDP_EN_A, 31>;
impl<'a> ENDP_EN_W<'a> {
    #[doc = "Disable"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 31 - Endpoint 3 Function enable bit"]
    #[inline(always)]
...
#[doc = "Offset:0x24 USB Endpoint 3 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ep3ctl](index.html) module"]
pub struct EP3CTL_SPEC;
impl crate::RegisterSpec for EP3CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ep3ctl::R](R) reader structure"]
impl crate::Readable for EP3CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ep3ctl::W](W) writer structure"]
impl crate::Writable for EP3CTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EP3CTL to value 0"]
impl crate::Resettable for EP3CTL_SPEC {
    #[inline(always)]
